...
<html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>游戏官网</title><meta name="description" content="${escape(sites.map(s=>s.name).join('、'))}官方网站入口"><link rel="canonical" href="${baseUrl}"><link rel="stylesheet" href="./hub.css"></head>
